...
export const followUnfollowerUser = async (req, res) => {
    try {
        ...
        if (isFollowing) {
            ...
            //todo return the id of yje user as a response
...
export const updateUser = async (req, res) => {
    ...
    try {
        ...
        if (profileImg) {
            ...
            const updateResponse = await cloudinary.uploader.upload(profileImg);
        ...
        if (coverImg) {
            ...
            const updateResponse = await cloudinary.uploader.upload(coverImg);
